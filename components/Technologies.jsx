...
const Technologies = () => {
  return (
    <section className="flex items-center justify-center pt-10 mx-auto container max-w-3xl px-4 md:px-0 z-50 animate-fade-up">
      <div className=" flex shadow-[0px_0px_8px_2px_rgba(207,250,254,0.8)] bg-conic/[from_var(--border-angle)] from-black via-cyan-200 to-black p-px flex-wrap justify-center items-center  w-60 h-60 sm:w-100 sm:h-100 rounded-full animate-rotate-border hover:scale-[1.03]">
