...
const GradientTopSection = () => {
  return (
    <div className="absolute left-[50%] top-0 -translate-y-[2%] z-0 flex h-[35rem] w-full max-w-[1200px] translate-x-[-50%] items-center justify-center md-[-2%] md:animate-slower">
